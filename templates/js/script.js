$(document).ready(function () {
	...
	$("#view-results").click(function (e) {$("#advanced").click(function (e) {
		...
		window.location.assign(window.location.origin + "/advanced/results/" + postdata.batch + "/" + postdata.branch + "/" + postdata.semester)
		// $.post("/advanced/results/"+postdata.batch+"/"+postdata.branch+"/"+postdata.semester, postdata, function (response) {
