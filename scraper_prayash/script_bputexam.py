...
students = Student.select(Student.student_id).where((Student.batch == 2017) &
                                                    (Student.branch == 'EE'))
# students = [{'student_id':1301106071}, {'student_id': 1301106267}, {'student_id':1301106021}]
...
for student in students:
    ...
    try:
        ...
        with open(filename, 'wb') as f:
            ...
            f.close()
            # print 'Saved ', student_id.student_id
